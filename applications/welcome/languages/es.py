...
'Error snapshot': 'Captura de error',
'Error ticket': 'Ticket de error',
ti'errors': 'errores',
'Errors': 'Errores',
...
'HTML export of visible columns': 'Exportación HTML de columnas visibles',
'htmledit': 'htmledit',
...
'JSON export of visible columns': 'Exportación JSON de columnas visibles',
'Key': 'Llave',
...
'Spreadsheet-optimised export of tab-separated content including hidden columns. May be slow': 'Exportación de contenido separado por tabuladores incluyendo columnas ocultas optimizada para hojas de cálculo. Puede ser lento',
'Spreadsheet-optimised export of tab-separated content, visible columns only. May be slow.': 'Exportación de contenido separado por tabuladores optimizada para hojas de cálculo, solo columnas visibles. Puede ser lento',
'start': 'inicio',
...
'TSV (Spreadsheets, hidden cols)': 'TSV (Hojas de cálculo, columnas ocultas)',
'Twitter': 'Twitter',
...
'Working...': 'Trabajando...',
'XML export of columns shown': 'Exportación XML de columnas mostradas',
'YES': 'SÍ',
